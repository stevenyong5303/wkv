cordova.define("com.bandpad.cordova.audiofrequency.AudioFrequencyProxy", function(require, exports, module) { var audioContext = new (window.AudioContext || window.webkitAudioContext)();
var gainNode,
    audioInput,
    analyser,
    dataArray,
